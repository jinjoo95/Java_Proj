...
public class ConsoleOutput3 {
	public static void main(String[] args) {
		...
		// 우리 아버님 이름은 홍길동 이고, 우리어머님 이름은 홍길순 입니다.
		// 나의 이름은 홍당무 이고, 나이는 25 살이고, 몸무게는 70.5 입니다.
		
		System.out.println("우리 아버님 이름은 " + fatherName + " 이고, 우리어머님 이름은 " + motherName + " 입니다.");
		...
		System.out.print("나의 이름은 홍당무 이고, 나이는 25살이고, 몸무게는 70.5 입니다. ");
		
		
		//3. printf()      : 문자열내에서 콤마 뒤의 값을 불러들여서 출력
		System.out.println("====printf() 으로 출력 ======");
		System.out.printf("우리 아버님 이름은 %s 이고, 우리 어머님 이름은 %s 입니다. \n", fatherName, motherName);
		System.out.printf("나의 이름은 %s 이고, 나이는 %d 살이고, 몸무게는 %f 입니다. ",  myName, age, weith);
